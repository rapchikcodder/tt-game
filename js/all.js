...
! function(t) {
    var a = function() {
        function t(t, a, e, s, i, o) {
            void 0 === o && (o = !0), this.oAssetData = {}, this.assetsLoaded = 0, this.textData = {}, this.spinnerRot = 0, this.totalAssets = a.length, this.showBar = o;
            for (var r = 0; r < a.length; r++) - 1 != a[r].file.indexOf(".json") ? this.loadJSON(a[r]) : this.loadImage(a[r]);
        ...
        return t.prototype.render = function() {
            ...
            for (var a = new Array, e = "", s = "", i = 0, o = t.lastIndexOf("."), r = !0; r;) o--, 0 == i && this.isNumber(t.charAt(o)) ? e = t.charAt(o) + e : 0 == i && e.length > 0 && "x" == t.charAt(o) ? (o--, i = 1, s = t.charAt(o) + s) : 1 == i && this.isNumber(t.charAt(o)) ? s = t.charAt(o) + s : 1 == i && s.length > 0 && "_" == t.charAt(o) ? (r = !1, a = [parseInt(s), parseInt(e)]) : (r = !1, a = [0, 0]);
            return a
        ...
        return t.prototype.updateAnimation = function(t) {
            ...
            if (t.save(), t.translate(this.x, this.y), t.rotate(this.rotation), t.scale(this.scaleX, this.scaleY), t.globalAlpha = this.alpha, null != this.animId) {
                ...
                if ("once" == this.animType && e > this.maxIdx) {
                    ...
                    s = this.fixedFrame * this.oImgData.oData.spriteWidth % this.oImgData.img.width, i = Math.floor(this.fixedFrame / (this.oImgData.img.width / this.oImgData.oData.spriteWidth)) * this.oImgData.oData.spriteHeight
                }
            } else s = this.fixedFrame * this.oImgData.oData.spriteWidth % this.oImgData.img.width, i = Math.floor(this.fixedFrame / (this.oImgData.img.width / this.oImgData.oData.spriteWidth)) * this.oImgData.oData.spriteHeight;
...
function(t) {
    var a = function() {
        ...
        return t.prototype.hitDown = function(t, a, e, s) {
            if (t.preventDefault(), t.stopPropagation(), hasFocus || visibleResume(), !this.pauseIsOn) {
                ...
                for (var o = 0; o < this.aHitAreas.length; o++)
                    if (this.aHitAreas[o].rect) {
                        ...
                        if (a > r + this.aHitAreas[o].area[0] && e > n + this.aHitAreas[o].area[1] && a < r + this.aHitAreas[o].area[2] && e < n + this.aHitAreas[o].area[3]) {
            ...
            if (!this.pauseIsOn) {
                if (!isMobile && null != userBat && !firstRun)
                    if (document.pointerLockElement === canvas || document.mozPointerLockElement === canvas) {
                        ...
                        window.famobi.pointerLockHelper && (window.famobi.pointerLockHelper.mousePos.x + a < window.innerWidth && window.famobi.pointerLockHelper.mousePos.x + a > 0 && (window.famobi.pointerLockHelper.mousePos.x += a), window.famobi.pointerLockHelper.mousePos.y + e < window.innerHeight && window.famobi.pointerLockHelper.mousePos.y + e > 0 && (window.famobi.pointerLockHelper.mousePos.y += e)), userBat.targX = window.famobi.pointerLockHelper.mousePos.x * canvasScale, userBat.targY = window.famobi.pointerLockHelper.mousePos.y * canvasScale
                    } else userBat.targX = a * canvasScale, userBat.targY = e * canvasScale, window.famobi.pointerLockHelper && (window.famobi.pointerLockHelper.mousePos = {
                        x: a,
                        y: e
                    });
                if (i) {
            ...
            void 0 === o && (o = !1), null == e && (e = new Object), o && this.removeHitArea(t), i.scale || (i.scale = 1), i.align || (i.align = [0, 0]);
            var r = new Array;
            switch (s) {
                case "image":
                    var n;
                    n = new Array(i.aPos[0] - i.oImgData.oData.oAtlasData[i.id].width / 2 * i.scale, i.aPos[1] - i.oImgData.oData.oAtlasData[i.id].height / 2 * i.scale, i.aPos[0] + i.oImgData.oData.oAtlasData[i.id].width / 2 * i.scale, i.aPos[1] + i.oImgData.oData.oAtlasData[i.id].height / 2 * i.scale), this.aHitAreas.push({
                        id: t,
                        aTouchIdentifiers: r,
                        callback: a,
                        oData: e,
...
function(t) {
    var a = function() {
        ...
        return t.prototype.renderGame = function() {
            ...
            t = this.oGameElementsImgData.oData.oAtlasData[oImageIds["tableBg" + this.wallId]].x, a = this.oGameElementsImgData.oData.oAtlasData[oImageIds["tableBg" + this.wallId]].y, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds["tableBg" + this.wallId]].width, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds["tableBg" + this.wallId]].height;
        ...
        return t.prototype.update = function() {
            ...
            switch (void 0 === t && (t = !0), t || this.addButs(ctx), this.panelType) {
                ...
                case "start":
                    ...
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].height;
                    ...
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].height;
                    ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, canvas.width / 2 - (s / 2 + 50) * o, .57 * canvas.height - (i / 2 + 50) * o - this.posY / 3, s * o, i * o);
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].height;
                    ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, canvas.width / 2 - s / 2, .2 * canvas.height - i / 2 + 80 - this.posY / 2, s, i);
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleLogo].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleLogo].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleLogo].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleLogo].height;
                ...
                case "chooseCountry":
                    for (var r = 0; r < countryFlags.aIds.length / 2; r++) {
                        ...
                        a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].height;
                    ...
                    var m = flagPage + 1,
                        l = canvas.width / 2 - 20,
                        g = canvas.height - 28,
                        d = (o = .75, m * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width),
                    ...
                    d = (m = 10) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width, u = Math.floor(m / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                    ...
                    d = (m = 2) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width, u = Math.floor(m / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                    ...
                    break;
                case "map":
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].height;
                    ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, 0, .5 * canvas.height - i / 2 + this.posY / 2, canvas.width, i);
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].height;
                    ...
                    for (r = 0; r < aMapMarkerPos.length; r++) {
                        var c = canvas.width / 2 + aMapMarkerPos[r][0],
                            ...
                            D = 0;
                        r < oGameData.cupId ? D = 2 : r == oGameData.cupId && (D = 1, this.flare(c, I, .5));
                        a = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + D]].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + D]].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + D]].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + D]].height;
                        ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, c - s / 2, I - i / 2, s, i);
                        for (var p = (r + 1).toString(), f = 0; f < p.length; f++) {
                            o = .23, d = (m = parseFloat(p.charAt(f))) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width, u = Math.floor(m / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                        ...
                        o = .5;
                        if (2 == D) {
                            a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].height;
                            ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, c - s / 2 * o + 26, I - i / 2 * o - 12, s * o, i * o)
                        } else if (1 == D) {
                            a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].height;
                            ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, c - s / 2 * o + 26, I - i / 2 * o - 12, s * o, i * o);
                            a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].height;
                ...
                case "gameIntro":
                    ...
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].height, o = Math.min(canvas.height / 3 / i, 1);
                    ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, canvas.width / 2 - s / 2 * o, .3 * canvas.height - i / 2 * o - this.posY / 2, s * o, i * o);
                    l = 22, g = 120, d = (m = oGameData.gameId + 1) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width, u = Math.floor(m / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                    ...
                    d = (m = 6) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width, u = Math.floor(m / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                    ...
                    o = .8, a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].height;
                    if (ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, 5, 5 - this.posY / 2, s * o, i * o), this.cupFlipInc += 4 * delta, Math.floor(this.cupFlipInc) % 2 == 0) {
                        var b = 2,
                            w = (a = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].height, oGameData.gameId + 1);
                        ctx.drawImage(this.oUiElementsImgData.img, a, e + i - w / 6 * i, s, Math.max(1 / 6 * i, .1), 5, 5 + (i - w / 6 * i) * o - this.posY / 2, s * o, Math.max(1 / 6 * i, .1) * o)
                    }
                    b = 3, a = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].height, w = oGameData.gameId;
                    ctx.drawImage(this.oUiElementsImgData.img, a, e + i - w / 6 * i, s, Math.max(w / 6 * i, .1), 5, 5 + (i - w / 6 * i) * o - this.posY / 2, s * o, Math.max(w / 6 * i, .1) * o);
                    d = (m = 10) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width, u = Math.floor(m / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                    ...
                    d = (m = oGameData.gameId + 1) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width, u = Math.floor(m / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                    ctx.drawImage(this.oLargeNumbersImgData.img, d, u, this.oLargeNumbersImgData.oData.spriteWidth, this.oLargeNumbersImgData.oData.spriteHeight, canvas.width / 2 - this.oLargeNumbersImgData.oData.spriteWidth / 2 + this.largeNumberSpace / 2, .2 * canvas.height - this.oLargeNumbersImgData.oData.spriteHeight / 2 - this.posY, this.oLargeNumbersImgData.oData.spriteWidth, this.oLargeNumbersImgData.oData.spriteHeight);
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].height;
                    ...
                    break;
                case "game":
                    a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].width, i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].height;
                    ctx.drawImage(this.oGameElementsImgData.img, a, e, s, i, canvas.width / 2 - s / 2 - 22, 0 - this.posY / 2, s, i * this.userCardScale);
                    var v = oGameData.userScore.toString();
                    for (r = 0; r < v.length; r++) {
                        d = (m = parseFloat(v.charAt(r))) * this.oScoreNumbersImgData.oData.spriteWidth % this.oScoreNumbersImgData.img.width, u = Math.floor(m / (this.oScoreNumbersImgData.img.width / this.oScoreNumbersImgData.oData.spriteWidth)) * this.oScoreNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oScoreNumbersImgData.img, d, u, this.oScoreNumbersImgData.oData.spriteWidth, this.oScoreNumbersImgData.oData.spriteHeight, canvas.width / 2 - 24 + r * this.scoreNumberSpace - v.length * this.scoreNumberSpace / 2, 15 - this.posY / 2, this.oScoreNumbersImgData.oData.spriteWidth, this.oScoreNumbersImgData.oData.spriteHeight * this.userCardScale)
                    }
                    a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].width, i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].height;
                    ctx.drawImage(this.oGameElementsImgData.img, a, e, s, i, canvas.width / 2 - s / 2 + 22, 0 - this.posY / 2, s, i * this.enemyCardScale);
                    for (v = oGameData.enemyScore.toString(), r = 0; r < v.length; r++) {
                        d = (m = parseFloat(v.charAt(r))) * this.oScoreNumbersImgData.oData.spriteWidth % this.oScoreNumbersImgData.img.width, u = Math.floor(m / (this.oScoreNumbersImgData.img.width / this.oScoreNumbersImgData.oData.spriteWidth)) * this.oScoreNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oScoreNumbersImgData.img, d, u, this.oScoreNumbersImgData.oData.spriteWidth, this.oScoreNumbersImgData.oData.spriteHeight, canvas.width / 2 + 19 + r * this.scoreNumberSpace - v.length * this.scoreNumberSpace / 2, 15 - this.posY / 2, this.oScoreNumbersImgData.oData.spriteWidth, this.oScoreNumbersImgData.oData.spriteHeight * this.enemyCardScale)
                    }
                    ...
                    h = countryFlags.getBData(oGameData.enemyId);
                    if (ctx.drawImage(this.oCountryFlagsImgData.img, h.bX, h.bY, h.bWidth, h.bHeight, canvas.width / 2 - h.bWidth / 2 * o + 80, 10 - this.posY, h.bWidth * o, h.bHeight * o), firstRun) {
                        ctx.fillStyle = "rgba(0, 0, 0, 0.5)", ctx.fillRect(0, 0, canvas.width, canvas.height);
                        a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].height;
                        ...
                        a = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + y]].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + y]].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + y]].width, i = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + y]].height;
                        if (ctx.drawImage(this.oGameElementsImgData.img, a, e, s, i, -s / 2, -i / 3, s, i), ctx.restore(), o = .4, this.ballY < 20) {
                            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].width, i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].height;
                        ...
                        o = .4;
                        a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].width, i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].height;
                        ...
                        a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].width, i = this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].height;
                ...
                case "gameComplete":
                    ...
                    if (ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, 0, .55 * canvas.height - i / 2 + this.posY / 2, canvas.width, i), justWonCup) {
                        ...
                        b = 3, a = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + b]].height;
                        ...
                        l = 22, g = 120, d = (m = oGameData.gameId) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width, u = Math.floor(m / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oSmallNumbersImgData.img, d, u, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight, l, g - this.posY / 2, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight);
                        d = (m = 10) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width, u = Math.floor(m / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oSmallNumbersImgData.img, d, u, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight, l + this.smallNumberSpace, g - this.posY / 2, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight);
                        d = (m = 6) * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width, u = Math.floor(m / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                        ...
                        a = this.oUiElementsImgData.oData.oAtlasData[S].x, e = this.oUiElementsImgData.oData.oAtlasData[S].y, s = this.oUiElementsImgData.oData.oAtlasData[S].width, i = this.oUiElementsImgData.oData.oAtlasData[S].height;
                        ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, canvas.width / 2 - s / 2, .2 * canvas.height - i / 2 - this.posY, s, i)
                    }
                    a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].x, e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].y, s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].width, i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].height;
                    ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, canvas.width / 2 - s / 2, .55 * canvas.height - i / 2 + 80 - this.posY / 4, s, i);
                    for (v = oGameData.userScore.toString(), r = 0; r < v.length; r++) {
                        d = (m = parseFloat(v.charAt(r))) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width, u = Math.floor(m / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oLargeNumbersImgData.img, d, u, this.oLargeNumbersImgData.oData.spriteWidth, this.oLargeNumbersImgData.oData.spriteHeight, canvas.width / 2 - 120 + r * this.largeNumberSpace - v.length * this.largeNumberSpace / 2, .55 * canvas.height - 10 - i / 2 - this.posY / 3, this.oLargeNumbersImgData.oData.spriteWidth, this.oLargeNumbersImgData.oData.spriteHeight)
                    }
                    d = (m = 12) * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width, u = Math.floor(m / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
            ...
            void 0 === e && (e = 1), this.flareRot += delta;
            ...
            ctx.drawImage(this.oUiElementsImgData.img, i, o, r, n, -r / 2, -n / 2, r, n), ctx.scale(1 * (1 - s), 1 * (1 + s)), ctx.scale(1 * (1 - s), 1 * (1 + s)), ctx.rotate(2 * -this.flareRot), ctx.drawImage(this.oUiElementsImgData.img, i, o, r, n, -r / 2, -n / 2, r, n), ctx.restore()
            ...
            for (var a = 0; a < this.aButs.length; a++) {
                ...
                var i = this.aButs[a].oImgData.oData.oAtlasData[this.aButs[a].id].x,
                    ...
                    h = canvas.width * this.aButs[a].align[0],
                    m = canvas.height * this.aButs[a].align[1];
                t.drawImage(this.aButs[a].oImgData.img, i, o, r, n, h + this.aButs[a].aPos[0] - r / 2 * this.aButs[a].scale + e - s / 2, m + this.aButs[a].aPos[1] - n / 2 * this.aButs[a].scale + s / 2, r * this.aButs[a].scale + s, n * this.aButs[a].scale - s)
            }
        }, t
    }();
    t.Panel = a
...
function(t) {
    var a = function() {
        ...
        return t.prototype.update = function() {
            ...
            t = this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].x, a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].y, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].width, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].height;
...
function(t) {
    var a = function() {
        ...
        return t.prototype.resetToCentre = function() {
            ...
            this.y = this.targY + canvas.height / 4 + 50 * tableTop.offsetY - 45, this.trackBall ? (this.x > ball.x + 15 ? this.slideInc = Math.max(this.slideInc - 1e3 * delta, -50 * this.skillLevel - 50) : this.x < ball.x - 15 && (this.slideInc = Math.min(this.slideInc + 1e3 * delta, 50 + 50 * this.skillLevel)), this.x += 4 * this.slideInc * delta, "enemy" == ball.lastHit && (this.targX = this.x - canvas.width / 2, this.moveTween = TweenLite.to(this, (.35 * Math.random() + .3) * (1 + .5 * (1 - this.skillLevel)), {
...
function(t) {
    var a = function() {
        ...
        return t.prototype.resetServe = function(t) {
            ...
            this.spin = t.spin, this.spinInc = 0, "enemy" == this.lastHit ? (this.targBounceX = t.x, this.targBounceY = t.y, this.speed = t.speed, tableTop.tweenToPos(this.targBounceX, this.targBounceY, this.speed, this.lastHit, this.spin), 0 == this.servingState ? (this.servingState = 1, this.heightInc = -(6 * this.height - 2400) * (.8 - this.speed) * 1.2, this.speed = (this.speed - .3) / 4 + .3) : this.heightInc = (6 * this.height - 2400) * (.8 - this.speed)) : (this.targBounceX = t.x, this.targBounceY = t.y, this.speed = t.speed, 0 == this.servingState ? (this.servingState = 1, this.heightInc = -(6 * this.height - 2400) * (.8 - this.speed) * 1.2, this.speed = (this.speed - .3) / 6 + .3) : this.heightInc = (6 * this.height - 2400) * (.8 - this.speed), tableTop.tweenToPos(0, 1, this.speed, this.lastHit, this.spin), enemyBat.setBouncePos(this.targBounceX, this.targBounceY, this.spin)), this.tableVX = (this.targBounceX - this.tablePosX) / (1.1 * (1 - this.speed)), this.tableVY = (this.targBounceY - this.tablePosY) / (1.1 * (1 - this.speed))
        }, t.prototype.update = function() {
            ...
            t = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].x, a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].y, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].width, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].height;
...
function(t) {
    var a = function() {
        ...
        return t.prototype.bounce = function() {
            ...
            var n = .5;
            "enemy" == s && (n = .5, r = (1 - 2 * (a - .5)) * (.3 - (e - .3)) / .3), this.offsetTween = TweenLite.to(this, n, {
                offsetX: o,
                offsetY: r,
                ease: "Quad.easeOut"
            })
            ...
            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].width, t = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].height;
            ...
            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].width, t = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].height;
            for (var i = 0; i < this.segs; i++) ctx.drawImage(this.oGameElementsImgData.img, a, e + t / this.segs * i, s, t / this.segs, canvas.width / 2 - s / 2 * (1 + this.offsetY / 3) + this.offsetX * (i * (100 / this.segs)) * 3 * (1 + this.offsetY / 3) + this.offsetX * this.sideMultiplier, canvas.height / 4 + t / this.segs * i * (1 + this.offsetY / 2) + 50 * this.offsetY, s * (1 + this.offsetY / 3), t / this.segs * (1 + this.offsetY / 2));
            a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].width, t = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].height;
            if (ctx.drawImage(this.oGameElementsImgData.img, a, e, s, t, canvas.width / 2 - s / 2 * (1 + this.offsetY / 3) + 100 * this.offsetX * 3 * (1 + this.offsetY / 3) + this.offsetX * this.sideMultiplier, canvas.height / 4 + this.oGameElementsImgData.oData.oAtlasData[oImageIds.table0].height * (1 + this.offsetY / 2) + 50 * this.offsetY, s * (1 + this.offsetY / 3), t * (1 + this.offsetY / 3)), this.bounceMarkScale > 0) {
                a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].width, t = this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].height;
                ...
                ctx.drawImage(this.oGameElementsImgData.img, a, e, s, t, r - s / 2 * (n * this.bounceMarkScale), o - t / 2 * (n * this.bounceMarkScale), s * (n * this.bounceMarkScale), t * (n * this.bounceMarkScale))
            }
...
function(t) {
    var a = function() {
        ...
        return t.prototype.createTextObjects = function() {
            ...
            var m = 1 * n;
            t.maxWidth && this.oTextData[t.text].blockWidth * n > t.maxWidth && (m = t.maxWidth / this.oTextData[t.text].blockWidth), t.anim && (this.inc += 7 * delta);
            for (var l = 0; l < e.length; l++) {
                a = 0, "centre" == t.alignX && (i = this.oTextData[t.text].aLineWidths[l] / 2), "centre" == t.alignY && (o = this.oTextData[t.text].blockHeight / 2 + r * (e.length - 1) / 2);
                for (var g = 0; g < e[l].length; g++) {
                    var d = e[l][g]["@x"],
                        u = e[l][g]["@y"],
                        c = e[l][g]["@width"],
                        I = e[l][g]["@height"];
                    t.anim && (h = Math.sin(this.inc + g / 2) * (I / 15 * m)), ctx.drawImage(s.img, d, u, c, I, t.x + (a + parseInt(e[l][g]["@xoffset"]) - i) * m, t.y + (parseInt(e[l][g]["@yoffset"]) + l * this.oTextData[t.text].lineHeight + l * r - o) * m + h, c * m, I * m), a += parseInt(e[l][g]["@xadvance"])
                }
            }
        }, t
    }();
...
function(t) {
    var a = function() {
        function t(t, a) {
            void 0 === a && (a = !1), this.aAllCountryCodes = {
                0: "ES",
                1: "AU",
                2: "AT",
                3: "AG",
...
function initSplash() {
    ...
    1234 == t ? firstRun = !0 : (firstRun = !1, oGameData.userId = t), controlState = saveDataHandler.getControlState(), window.famobi.localStorage.getItem("muted") && (muted = !1, toggleMute(!0)), window.famobi.onRequest("startGame", function() {}), window.famobi.onRequest("enableAudio", function() {
        ...
        "game" == gameState && butEventHandler("pause", !0)
    }), window.famobi.onRequest("resumeGameplay", function() {
        "pause" == gameState && butEventHandler("playFromPause", !0)
    }), 1 != audioType || muted || (playMusic(), hasFocus || music.pause()), initStartScreen()
}

function initStartScreen() {
    if (background = new Elements.Background, skipTitle) firstRun ? initChooseCountry() : initGameIntro();
    else {
        gameState = "start", flagPage = 0;
        1 == audioType && music.fade(music.volume(), .5, 500), userInput.removeHitArea("moreGames");
        var t = {
        ...
        userInput.addHitArea("playFromStart", butEventHandler, null, "image", t), userInput.addHitArea("moreGames", butEventHandler, null, "image", a), userInput.addHitArea("credits", butEventHandler, null, "image", e);
        ...
        if (!firstRun) {
            ...
            userInput.addHitArea("cupsFromStart", butEventHandler, null, "image", o), s.push(i, o)
        }
        addMuteBut(s), (panel = new Elements.Panel(gameState, s)).startTween1(), previousTime = (new Date).getTime(), updateStartScreenEvent(), window.famobi.gameReady()
    }
}
...
function initCreditsScreen() {
    ...
    userInput.addHitArea("backFromCredits", butEventHandler, null, "image", t), userInput.addHitArea("resetData", butEventHandler, null, "image", a);
    ...
    isMobile && (0 == controlState ? (e = {
        ...
        noMove: !0
    }), userInput.addHitArea("control0FromCredits", butEventHandler, null, "image", e), userInput.addHitArea("control1FromCredits", butEventHandler, null, "image", s), i.push(e, s));
    addMuteBut(i), (panel = new Elements.Panel(gameState, i)).startTween1(), previousTime = (new Date).getTime(), updateCreditsScreenEvent()
}
...
function initChooseCountry() {
    ...
    var t = {
        ...
        a = new Array;
    if (0 == flagPage && skipTitle || (a = new Array(t), userInput.addHitArea("backFromChooseCountry", butEventHandler, null, "image", t)), 0 == flagPage) {
        var e = {
            oImgData: assetLib.getData("uiButs"),
            aPos: [-30, -32],
            align: [1, 1],
        ...
        userInput.addHitArea("moreFromChooseCountry", butEventHandler, null, "image", e), a.push(e)
    }
    for (var s = assetLib.getData("uiElements"), i = s.oData.oAtlasData[oImageIds.countryBut].width, o = s.oData.oAtlasData[oImageIds.countryBut].height, r = 0; r < countryFlags.aIds.length / 2; r++) {
        var n = r + flagPage * (countryFlags.aIds.length / 2),
            h = canvas.width / 2 - i / 2 + 120 * (r % 4 - 2) + 60,
    ...
    addMuteBut(a), (panel = new Elements.Panel(gameState, a)).startTween1(), previousTime = (new Date).getTime(), updateChooseCountryScreenEvent(), window.famobi.gameReady()
}
...
function initGameIntro() {
    ...
    userInput.addHitArea("backFromGameIntro", butEventHandler, null, "image", t), userInput.addHitArea("playFromGameIntro", butEventHandler, null, "image", a);
    var e = new Array(t, a);
    addMuteBut(e), (panel = new Elements.Panel(gameState, e)).startTween1(), previousTime = (new Date).getTime(), updateGameIntroScreenEvent(), window.famobi.gameReady()
}
...
function _initGame() {
    gameState = "game", window.famobi.hasFeature("lockPointer") && (window.famobi.pointerLockHelper || (window.famobi.pointerLockHelper = {}), window.famobi.pointerLockHelper.mousePos = {
        x: window.innerWidth / 2,
        y: window.innerHeight / 2
    }, userInput.lockPointer()), playSound("gameStart");
    ...
    if (firstRun) {
        ...
        userInput.addHitArea("tickFromTut", butEventHandler, null, "image", a), t.push(a)
    } else {
        ...
        externalPause || window.famobi.pointerLockHelper || (userInput.addHitArea("pause", butEventHandler, null, "image", e), t.push(e))
    }
    window.famobi.pointerLockHelper || addMuteBut(t), (panel = new Elements.Panel(gameState, t)).startTween1(), firstRun && !window.famobi.pointerLockHelper && panel.startTut(), tableTop = new Elements.TableTop, userBat = new Elements.UserBat, enemyBat = new Elements.EnemyBat, ball = new Elements.Ball, previousTime = (new Date).getTime(), updateGameEvent()
}
...
function initPause() {
    ...
    userInput.addHitArea("playFromPause", butEventHandler, null, "image", t), userInput.addHitArea("restartFromPause", butEventHandler, null, "image", a), userInput.addHitArea("quitFromPause", butEventHandler, null, "image", e);
    ...
    isMobile && (0 == controlState ? (s = {
        ...
        id: oImageIds.control1OnBut,
        noMove: !0
    }), userInput.addHitArea("control0FromPause", butEventHandler, null, "image", s), userInput.addHitArea("control1FromPause", butEventHandler, null, "image", i), o.push(s, i));
...
function resumeGame() {
    ...
    var t = {
        ...
        a = new Array;
    externalPause || (userInput.addHitArea("pause", butEventHandler, null, "image", t), a = new Array(t)), addMuteBut(a), (panel = new Elements.Panel(gameState, a)).startTween1(), previousTime = (new Date).getTime(), updateGameEvent()
}
...
function butEventHandler(t, a) {
    switch (t) {
        ...
        case "playFromStart":
            ...
            break;
        case "countryChoice":
            playSound("hit" + Math.floor(6 * Math.random())), userInput.removeHitArea("backFromChooseCountry"), userInput.removeHitArea("moreFromChooseCountry"), userInput.removeHitArea("countryChoice"), oGameData.userId = countryFlags.aIds[a.id], saveDataHandler.setUserId(oGameData.userId), saveDataHandler.saveData(), firstRun ? initMapScreen() : initGameIntro();
            break;
        ...
        case "tickFromTut":
            ...
            externalPause || (userInput.addHitArea("pause", butEventHandler, null, "image", s), panel.aButs.push(s)), firstRun = !1;
            break;
        case "gameTouch":
            a.isDown && !a.isBeingDragged ? (swipeState = 1, startTouchY = a.y - userBat.targY) : 1 == swipeState && a.isBeingDragged ? (userBat.targX = a.x, userBat.targY = 0 == controlState ? a.y : a.y - startTouchY) : 1 == swipeState && (swipeState = 0);
            break;
        ...
        case "disableAudio":
            ...
            break;
        case "pause":
            !0 !== a && playSound("hit" + Math.floor(6 * Math.random())), 1 == audioType ? (Howler.mute(!0), music.pause()) : 2 == audioType && music.pause(), userInput.removeHitArea("pause"), userInput.removeHitArea("gameTouch"), userInput.removeHitArea("mute"), initPause();
            break;
        case "playFromPause":
            window.famobi.pointerLockHelper && userInput.lockPointer(), !0 !== a && playSound("hit" + Math.floor(6 * Math.random())), 1 == audioType ? muted || (Howler.mute(!1), playMusic()) : 2 == audioType && (muted || playMusic()), userInput.removeHitArea("quitFromPause"), userInput.removeHitArea("playFromPause"), userInput.removeHitArea("restartFromPause"), userInput.removeHitArea("control0FromPause"), userInput.removeHitArea("control1FromPause"), userInput.removeHitArea("mute"), resumeGame();
            break;
...
function _initGameComplete() {
    window.famobi.pointerLockHelper && userInput.unlockPointer(), gameState = "gameComplete", 1 == audioType && music.fade(music.volume(), .5, 500), userInput.removeHitArea("pause"), userInput.removeHitArea("gameTouch");
    var t, a = {
            oImgData: assetLib.getData("uiButs"),
            aPos: [30, -32],
            align: [0, 1],
        ...
        e = function() {
            t.scale = 1, a.scale = 1, userInput.addHitArea("nextFromGameComplete", butEventHandler, null, "image", t), userInput.addHitArea("backFromGameComplete", butEventHandler, null, "image", a)
        };
...
function addFirework(t, a, e) {
    if (void 0 === e && (e = 1), !(aEffects.length > 10)) {
...
function initLangSelect() {
    for (var t, a, e, s, i = 0, o = 0; o < aLangs.length && (o + 1) * (1 * (t = preAssetLib.getData("lang" + aLangs[o])).img.width) + 10 * (o + 2) < canvas.width; o++) i++;
...
function toggleMute(t) {
    muted = !muted, 1 == audioType ? muted ? (Howler.mute(!0), music.pause(), t || (window.famobi.localStorage.setItem("muted", "1"))) : (Howler.mute(!1), playMusic(), "game" == gameState ? music.volume(.1) : music.volume(.5), t || (window.famobi.localStorage.removeItem("muted"))) : 2 == audioType && (muted ? music.pause() : playMusic())
}